...
class wikipedia_page(object):
    ...
    def setupUi(self, wikipedi):
        ...
        self.centralwidget.setStyleSheet("background-color:rgb(92, 151, 158)")
        ...
        self.label.setStyleSheet("font: 700 30pt \"Times New Roman\";\n" "color: rgb(0, 60, 67);")
        ...
        self.lineEdit.setStyleSheet("background-color: rgb(92, 151, 158);\n" "border-color: rgb(0, 60, 67);")
        ...
        self.label_2.setStyleSheet("font: 700 30pt \"Times New Roman\";\n" "color: rgb(0, 60, 67);")
